...
const serial = async (
    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        const temp1 = Number((sensorAnalogico - 29).toFixed(1));
        const umi1 = Number((sensorDigital + 12).toFixed(1));

        const temp2 = Number((sensorAnalogico - 10).toFixed(1));
        const umi2 = Number((sensorDigital -18).toFixed(1));
